...
import { View, Text, ScrollView, FlatList, Share, Modal, StyleSheet, Button, Alert, PanResponder } from 'react-native';
            ...
            if (recognizeDrag(gestureState))
                Alert.alert(
                    ...
                    [
                        {
                            text: 'Cancle',
                            onPress: () => console.log('Cancle Pressed'), style: 'cancel'
                        },
                        {
                            text: 'OK',
